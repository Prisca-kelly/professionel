...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-u=j=ea+6_27&7ih#nb979=5^wcs_fwr7$=p2wlr6@$-%2sv-pl')
...
if not config('DATABASE_URL', default=None):
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='portail_enseignement_pro'),
